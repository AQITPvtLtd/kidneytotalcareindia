    ...
    <div className="lg:relative">
      <div>
        <Image
          ...
          width={1000}
          height={1000}
          className="lg:block hidden h-[500px] w-full object-cover"
          alt="feature"
        />
      </div>
      <div className="lg:flex items-stretch lg:absolute lg:inset-0 lg:p-10 p-5 gap-10">
        {/* Expertise and Experience */}
        <div className="lg:bg-white lg:m-10 shadow-md bg-sky-100 lg:p-7 p-4 rounded-xl flex-1">
        ...
        <div className="lg:bg-white shadow-md bg-sky-100 lg:m-10 mt-4 p-4 lg:p-7 rounded-xl flex-1">
          <div className="font-bold text-2xl pb-3">
